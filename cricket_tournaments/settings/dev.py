...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DB_NAME'),                      # Or path to database file if using sqlite3.
        'USER': os.getenv('MYSQL_USERNAME'),                      # Not used with sqlite3.
        'PASSWORD':os.getenv('MYSQL_PASSWORD'),                  # Not used with sqlite3.
        'HOST': os.getenv('MYSQL_HOST'),                      # Set to empty string for localhost. Not used with sqlite3.
